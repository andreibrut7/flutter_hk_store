...
import 'package:flutterstore/ui/subcategory/item/sub_category_search_list_item.dart';
                      ...
                      if (provider.subCategoryList.status ==
                        ...
                        return FadeTransition(
                            ...
                            child: SubCategorySearchListItem(
                              ...
                              onTap: () {
                               //print(provider.subCategoryList.data[index].defaultPhoto.imgPath);
                                Navigator.pop(context,
                                    provider.subCategoryList.data[index]);
                               //print( provider.subCategoryList.data[index].name);
                              },
                            ));
                      }
                    }),
